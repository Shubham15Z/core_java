...
Explanation: Change 1 to 7, 15 to 9 and 10 to 4. Maximum difference is 
5 (between 4 and 9). We can’t get a lower difference.
*/
...
public class Tower
{
	public static void main(String arg[])
	{
		...
		System.out.println();
		System.out.println("the maximum difference is : "+(arr[arr.length-1] - arr[0]));
	}
}